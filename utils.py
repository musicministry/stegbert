...
def video_table(hymns: dict, RA):
    ...
    RAnote = " <br> Other video recordings from *Respond & Acclaim* for rehearsal purposes can usually be found on several private YouTube channels such as <a href='https://www.youtube.com/@ChrisBrunelle/videos'>Chris Brunelle</a>, <a href='https://www.youtube.com/@LiturgicalMusic'>Liturgical Music</a>, or <a href='https://www.youtube.com/@MusicMinistry101/videos'>Music Ministry 101</a>."
...
def massparts_video_table(season:str, setting:str, include:list, urls=hymn_videos):
    ...
    include_keys = [keyify(f'{i.split(": ")[1]} {i.split(": ")[0]}') for i in include]
    ...
    for i, k in zip(include, include_keys):
        ...
        # Second column (content) - conditional logic
        if i.lower() == 'gloria' and (season.lower() == 'advent' or season.lower() == "lent"):
            content = f"<em>{i} is omitted during {season}.</em> <br><br>"
        else:
