...
The Rodgers Infinity 367D organ is a remarkably impressive instrument that would be a tremendous upgrade from the current organ at St. Egbert's. With three manuals, 67 stops, more than 500 organ voices, and 14 audio channels divided between a 10-channel main organ and a 4-channel antiphonal organ, this organ is plenty adequate for the size of the church and the needs of the existing music ministry. With the current organ beginning to show signs of its 32 years of service, the parish is encouraged to proactively begin raising funds now so that it can replace the instrument before it dies completely. While the Infinity's price tag of `{python} display(infinity367D_2026_total)` will require significant fundraising, it will constitute a dedicated investment in the future of the parish: its stunning fidelity to the sounds of pipe organs combined with endless possibilities of stop combinations and orchestral integrations will undoubtedly raise the parish's music program to a new level for decades to come.
